...
public class AutorizeDictionary {
	...
	public static final String FORM_ELEMENT_PERMISSION = "//form[@method='post']";
	...
	public static final String FORM_AUTORIZE_OK = "//form[@method='post']";
	public static final String OK_EMAIL_FIELD = "fr.email";
	public static final String OK_PASS_FIELD = "fr.password";
}
